...
* [`estimate-chain-transaction-gas`](#estimate-chain-transaction-gas)
...
#### `estimate-chain-transaction-gas`

Estimate consumed neu(1BTM = 10^8NEU) for the chain transactions.

##### Parameters

`Object`:

- `Array` - *transaction_templates*, the array of builded transaction response.
...
ret = api.estimate_chain_transaction_gas([transaction_template])
```
<details>
<summary>Output</summary>
